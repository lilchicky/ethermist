...
public class EMLeavesParticle extends TextureSheetParticle {
    ...
    protected EMLeavesParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet) {
        super(level, x, y, z);
        ...
        float brightness = 0.6F + this.random.nextFloat() * 0.4F;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z,
            ...
            return new EMLeavesParticle(level, x, y, z, this.spriteSet);
        }
