...
public class EMGameEvents {
    ...
    public static void onBrewingRecipeRegister(RegisterBrewingRecipesEvent event) {
        ...
        builder.addMix(Potions.AWKWARD, Items.AMETHYST_SHARD, EMPotions.ARCANE_AMPLIFICATION_POTION);
        builder.addMix(EMPotions.ARCANE_AMPLIFICATION_POTION, Items.REDSTONE, EMPotions.LONG_ARCANE_AMPLIFICATION_POTION);
        builder.addMix(EMPotions.ARCANE_AMPLIFICATION_POTION, Items.GLOWSTONE_DUST, EMPotions.STRONG_ARCANE_AMPLIFICATION_POTION);

        builder.addMix(EMPotions.ARCANE_AMPLIFICATION_POTION, Items.FERMENTED_SPIDER_EYE, EMPotions.ARCANE_DAMPENING_POTION);
        builder.addMix(EMPotions.ARCANE_DAMPENING_POTION, Items.REDSTONE, EMPotions.LONG_ARCANE_DAMPENING_POTION);
        builder.addMix(EMPotions.ARCANE_DAMPENING_POTION, Items.GLOWSTONE_DUST, EMPotions.STRONG_ARCANE_DAMPENING_POTION);
