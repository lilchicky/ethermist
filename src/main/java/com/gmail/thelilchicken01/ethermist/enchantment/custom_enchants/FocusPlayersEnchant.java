...
public record FocusPlayersEnchant() implements EnchantmentValueEffect {

    public static final MapCodec<FocusPlayersEnchant> CODEC = MapCodec.unit(FocusPlayersEnchant::new);
