...
public class AbyssalMushroomTrunkPlacer extends TrunkPlacer {

    public static final MapCodec<AbyssalMushroomTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(
            instance -> trunkPlacerParts(instance).apply(instance, AbyssalMushroomTrunkPlacer::new)
    );

    public AbyssalMushroomTrunkPlacer(int baseHeight, int heightRandA, int heightRandB) {
        super(baseHeight, heightRandA, heightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return EMTrunkPlacerType.ABYSSAL_MUSHROOM_TRUNK_PLACER.get();
    }
