...
public class AncientTrunkPlacer extends TrunkPlacer {
    ...
    public static final MapCodec<AncientTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec((p_70090_) -> trunkPlacerParts(p_70090_).apply(p_70090_, AncientTrunkPlacer::new));
